...
# (v+w = w+v), (u+(v+w) = (u+v)+w = u+v+w)
# if a & b are scalars and v is a vector, (a*(b*v) = (a*b)*v)
# (1 * v = v)
# (a * v + b * v) = ((a + b) * v)
# (a *(v + w)) = (a * v + a * w)
# A vector space is a collection of objects called vectors, equipped with suitable vector addition and scalar 
# multiplication operations (obeying the rules above), such that every linear combination of vectors in the collection
