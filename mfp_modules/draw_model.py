...
from math import *
from mfp_modules import camera, transforms, vectors
...
def shade(face,color_map=blues,light=(1,2,3)):
    return color_map(1 - vectors.dot(vectors.unit(normal(face)), vectors.unit(light)))
    ...
    while cam.is_shooting():
        ...
        def do_matrix_transform(v):
            if get_matrix:
                ...
                return v
        transformed_faces = transforms.polygon_map(do_matrix_transform, faces)
