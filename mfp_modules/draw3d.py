...
class Polygon3D():
    def __init__(self, *vertices,  color=colors.blue):
...
class Arrow3D():
    def __init__(self, tip, tail=(0,0,0),  color=colors.red):
        self.tip = tip
        self.tail = tail
        self.color = color

class Segment3D():
    def __init__(self, start_point, end_point,  color=colors.blue, linestyle='solid'):
